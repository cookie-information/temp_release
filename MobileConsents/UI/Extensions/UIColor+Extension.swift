...
extension UIColor {
    ...
    static let privacyCenterAcceptButtonTitle = UIColor.adaptive(light: .white, dark: .black)
    ...
    static let privacyCenterSwitch = UIColor.adaptive(light: .init(hex: 0x5DCB2F), dark: .white)
    static let privacyCenterSwitchThumb = UIColor.adaptive(light: .white, dark: .init(hex: 0x8D8D93))
